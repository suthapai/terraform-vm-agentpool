...
cd myagent
./config.sh --unattended --url https://dev.azure.com/sujethapai --auth pat --token 7EmJAbu4hnBsjjrleueyesobR2Xidq9gwuZMDPymZpAlAzXtKgrHJQQJ99BBACAAAAAAAAAAAAASAZDO2FBV --pool Default --agent aksagent --acceptTeeEula
